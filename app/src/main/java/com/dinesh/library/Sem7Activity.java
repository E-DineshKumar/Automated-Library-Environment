...
public class Sem7Activity extends Activity {
    String[] sem1subcode={"CS6701","CS6702","CS6703","CS6704"};
    String[] sem1bname={"Cryptography and Network Security","Graph Theory: With Application to Engineering and Computer Science","Distributed and Cloud Computing: Clusters,Grids, Clouds and the Future of Internet","Operation Research"};
    String[] sem1aname={"William Stallings","Narsingh Deo","Kai Hwang, Geoffery C. Fox and Jack J. Dongarra","H.A. Taha"};
    String[] sem1edition={"6th Edition","","1st Edition",""};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem7);
        ListView books=(ListView)findViewById(R.id.listViewsem7);
