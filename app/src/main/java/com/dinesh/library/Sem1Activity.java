...
public class Sem1Activity extends Activity {
        String[] sem1bname={"TECHNICAL ENGLISH-I","A text book of Engineering Mathematics","Engineering Physics","Engineering Chemistry","Programming with C","Engineering Drawing"};
    String[] sem1aname={"","Bali N.P and Manish Goyal","Arumugam M","Jain P.C. and Monica Jain","Byron S G ottfried","Bhatt N.D and Panchal V.M"};
    String[] sem1edition={"","8th Edition","","","2nd Edition","50th Edition"};
    String[] sem1subcode={"HS6151","MA6151","PH6151","CY6151","GE6151","GE6152"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem1);
         ListView books=(ListView)findViewById(R.id.listViewsem1);
