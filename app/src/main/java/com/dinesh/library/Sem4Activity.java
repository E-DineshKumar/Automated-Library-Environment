...
public class Sem4Activity extends Activity {
    String[] sem1subcode={"MA6453","CS6551","CS6401","CS6402","EC6504","CS6403"};
    String[] sem1bname={"Fundamentals of Applied Probability and Random Processes","Computer Networks:A Systems Approach","Operating System Concepts","Introduction to Design and Analysis of Algorithms","The 8051 Microcontroller and\n" +
            "Embedded Systems: Using Assembly and C","Software Engineering – A Practitioner’s Approach"};
    String[] sem1aname={"Ibe.O.C","Larry L.Peterson, Bruce S. Davie","Abraham Silberschatz, Peter Baer Galvin and Greg  Gangne","Anany Levitin","Mohamed Ali Mazidi, Janice Gillispie Mazidi, Rolin McKinlay","Roger S. Pressman"};
    String[] sem1edition={"1st Reprint","5th Edition","9th Edition","3rd Edition","2nd Edition","7th Edition"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem4);
        ListView books=(ListView)findViewById(R.id.listViewsem4);
